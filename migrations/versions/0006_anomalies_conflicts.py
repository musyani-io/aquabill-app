...
revision: str = "0006_anomalies_conflicts"
down_revision: Union[str, None] = "0005_readings"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            nullable=True,
            comment="Admin ID who acknowledged",
        ),
        ...
        sa.ForeignKeyConstraint(
            ...
            name="fk_anomalies_meter_assignment",
            ondelete="RESTRICT",
        ),
        sa.ForeignKeyConstraint(
            ["cycle_id"], ["cycles.id"], name="fk_anomalies_cycle", ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
            ["reading_id"],
            ["readings.id"],
            name="fk_anomalies_reading",
            ondelete="SET NULL",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(length=100),
            nullable=True,
            comment="Admin email/ID assigned to resolve",
        ),
        ...
        sa.ForeignKeyConstraint(
            ["meter_assignment_id"],
            ["meter_assignments.id"],
            name="fk_conflicts_meter_assignment",
            ondelete="RESTRICT",
        ),
        sa.ForeignKeyConstraint(
            ["cycle_id"], ["cycles.id"], name="fk_conflicts_cycle", ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["reading_id"],
            ["readings.id"],
            name="fk_conflicts_reading",
            ondelete="SET NULL",
        ),
    ...
    op.create_index(
        "ix_anomalies_meter_assignment_id", "anomalies", ["meter_assignment_id"]
    )
    ...
    op.create_index(
        "ix_conflicts_meter_assignment_id", "conflicts", ["meter_assignment_id"]
    )
