...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "type", sa.String(length=20), nullable=False, server_default="NORMAL"
        ),
        sa.Column(
            "consumption",
        ...
        sa.Column(
            ...
            comment="True if meter value wrapped/reset",
        ),
        sa.Column(
            "submitted_at",
            sa.DateTime(),
        ...
        sa.Column(
            ...
            nullable=False,
            comment="User/operator ID who submitted",
        ),
        ...
        sa.ForeignKeyConstraint(
            ...
            name="fk_readings_meter_assignment",
            ondelete="RESTRICT",
        ),
        sa.ForeignKeyConstraint(
            ["cycle_id"], ["cycles.id"], name="fk_readings_cycle", ondelete="RESTRICT"
        ),
        ...
        sa.CheckConstraint(
            "type IN ('BASELINE', 'NORMAL')", name="ck_reading_type_valid"
        ),
        sa.CheckConstraint(
    ...
    op.create_index(
        "ix_readings_meter_assignment_id", "readings", ["meter_assignment_id"]
    )
