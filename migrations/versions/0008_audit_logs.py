...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            'action',
            sa.Enum(
                'READING_APPROVED', 'READING_REJECTED', 'READING_EDITED', 'READING_DELETED',
                'CYCLE_CREATED', 'CYCLE_STATE_CHANGED', 'CYCLE_APPROVED', 'CYCLE_CLOSED', 'CYCLE_ARCHIVED',
                'CONFLICT_RESOLVED', 'CONFLICT_ASSIGNED', 'ANOMALY_ACKNOWLEDGED',
                'PENALTY_APPLIED', 'PENALTY_WAIVED', 'PAYMENT_RECORDED', 'LEDGER_ADJUSTMENT',
                'METER_ASSIGNED', 'METER_UNASSIGNED', 'METER_CREATED',
                'CLIENT_CREATED', 'CLIENT_UPDATED', 'CLIENT_DELETED',
                'DATA_EXPORTED', 'BACKUP_CREATED', 'SETTINGS_CHANGED',
                name='auditaction'
            ),
            nullable=False
        ),
