...
def upgrade():
    ...
    op.alter_column(
        ...
        type_=sa.Enum(
            "PENDING", "SENT", "DELIVERED", "FAILED", "BOUNCED", name="smsstatus"
        ),
        nullable=True,
        existing_server_default=sa.text("'PENDING'::character varying"),
    )
...
def downgrade():
    ...
    op.create_index(
        op.f("ix_sms_messages_gateway_reference"),
        "sms_messages",
        ["gateway_reference"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_conflicts_cycle_id"), "conflicts", ["cycle_id"], unique=False
    )
    op.alter_column(
        "conflicts",
        "updated_at",
    ...
    op.create_table(
        ...
        sa.Column(
            "company_phone", sa.VARCHAR(length=20), autoincrement=False, nullable=False
        ),
        sa.Column(
            "role_at_company",
        ...
        sa.Column(
            "estimated_clients", sa.INTEGER(), autoincrement=False, nullable=False
        ),
        sa.Column(
            "created_at",
        ...
        sa.UniqueConstraint(
            "username",
            name=op.f("uq_admin_username"),
            postgresql_include=[],
            postgresql_nulls_not_distinct=False,
        ),
    )
    op.create_index(
        op.f("ix_admin_users_username"), "admin_users", ["username"], unique=False
    )
    op.create_table(
        "collector_users",
        sa.Column("id", sa.INTEGER(), autoincrement=True, nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["admin_id"],
            ["admin_users.id"],
            name=op.f("collector_users_admin_id_fkey"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("collector_users_pkey")),
    )
    op.create_index(
        op.f("ix_collector_users_admin_id"),
        "collector_users",
        ["admin_id"],
        unique=False,
    )
