...
class ConflictService:
    ...
    def assign_conflict(self, conflict_id: int, assigned_to: str) -> Tuple[Optional[Conflict], Optional[str]]:
        ...
        if conflict.status in [ConflictStatus.RESOLVED.value, ConflictStatus.ARCHIVED.value]:
    ...
    def archive_conflict(self, conflict_id: int) -> Tuple[Optional[Conflict], Optional[str]]:
