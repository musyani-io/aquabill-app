...
class AuditLogBase(BaseModel):
    ...
    admin_username: str = Field(..., max_length=100, description="Username of admin who performed action")
    ...
    metadata: Optional[str] = Field(None, description="JSON metadata with additional context")
    ip_address: Optional[str] = Field(None, max_length=45, description="IP address of admin")
