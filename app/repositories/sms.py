...
class SMSRepository:
    ...
    def get_by_idempotency_key(self, key: str) -> Optional[SMSMessage]:
        ...
        return self.db.query(SMSMessage).filter(SMSMessage.idempotency_key == key).first()
    ...
    def get_by_status(self, status: SMSStatus, skip: int = 0, limit: int = 100) -> List[SMSMessage]:
    ...
    def get_by_client(self, client_id: int, skip: int = 0, limit: int = 100) -> List[SMSMessage]:
    ...
    def get_by_phone(self, phone_number: str, skip: int = 0, limit: int = 100) -> List[SMSMessage]:
