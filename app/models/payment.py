...
class Payment(Base):
    ...
    meter_assignment_id = Column(Integer, ForeignKey("meter_assignments.id", ondelete="SET NULL"), nullable=True, index=True)
    ...
    method = Column(String(50), nullable=True, comment="cash, mobile money, bank transfer")
    notes = Column(String(500), nullable=True)
    recorded_by = Column(String(100), nullable=False, comment="User who recorded the payment")
