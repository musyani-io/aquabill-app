...
class Cycle(Base):
    ...
    target_date = Column(Date, nullable=False, comment="Deadline for reading submissions")
    status = Column(
        String(20), 
        nullable=False, 
        default=CycleStatus.OPEN.value,
        index=True
    )
    ...
    __table_args__ = (
        ...
        CheckConstraint("target_date >= start_date", name="ck_cycle_target_after_start"),
